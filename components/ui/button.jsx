...
const buttonVariants = cva(
  ...
  {
    variants'bg-primary text-primary-foreground hover-primary/90',
        destructive'bg-destructive text-white hover-destructive/90 focus-visible-destructive/20 dark-visible-destructive/40 dark-destructive/60',
        outline'border bg-background shadow-xs hover-accent hover-accent-foreground dark-input/30 dark-input dark-input/50',
        secondary'bg-secondary text-secondary-foreground hover-secondary/80',
        ghost'hover-accent hover-accent-foreground dark-accent/50',
        link'text-primary underline-offset-4 hover',
      },
      size'h-9 px-4 py-2 has-[>svg]-3',
