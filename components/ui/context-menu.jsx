...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus-accent focus-accent-foreground data-[state=open]-accent data-[state=open]-accent-foreground [&_svg([class*='text-'])]-muted-foreground flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[inset]-8 [&_svg]-events-none [&_svg]-0 [&_svg([class*='size-'])]-4",
        className,
      )}
      {...props}
    >
