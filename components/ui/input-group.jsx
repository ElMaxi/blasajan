...
const inputGroupAddonVariants = cva(
  ...
  {
    variants'inline-start''order-first pl-3 has-[>button]-[-0.45rem] has-[>kbd]-[-0.35rem]',
        'inline-end''order-last pr-3 has-[>button]-[-0.4rem] has-[>kbd]-[-0.35rem]',
        'block-start''order-first w-full justify-start px-3 pt-3 [.border-b]-3 group-has-[>input]/input-group-2.5',
        'block-end''order-last w-full justify-start px-3 pb-3 [.border-t]-3 group-has-[>input]/input-group-2.5',
      },
    },
    defaultVariants'inline-start',
    },
  },
)
...
const inputGroupButtonVariants = cva(
  ...
  {
    variants"h-6 gap-1 px-2 rounded-[calc(var(--radius)-5px)] [&>svg([class*='size-'])]-3.5 has-[>svg]-2",
        sm'h-8 px-2.5 gap-1.5 rounded-md has-[>svg]-2.5',
        'icon-xs''size-6 rounded-[calc(var(--radius)-5px)] p-0 has-[>svg]-0',
