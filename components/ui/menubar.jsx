...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        'focus-accent focus-accent-foreground data-[state=open]-accent data-[state=open]-accent-foreground flex items-center rounded-sm px-2 py-1 text-sm font-medium outline-hidden select-none',
        className,
      )}
      {...props}
    />
...
function MenubarCheckboxItem({
  ...
  return (
    <MenubarPrimitive.CheckboxItem
      ...
      className={cn(
        "focus-accent focus-accent-foreground relative flex cursor-default items-center gap-2 rounded-xs py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-[disabled]-events-none data-[disabled]-50 [&_svg]-events-none [&_svg]-0 [&_svg([class*='size-'])]-4",
        className,
      )}
      checked={checked}
      {...props}
...
function MenubarSubTrigger({
  ...
  return (
    <MenubarPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        'focus-accent focus-accent-foreground data-[state=open]-accent data-[state=open]-accent-foreground flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-none select-none data-[inset]-8',
        className,
      )}
      {...props}
    >
