...
const toastVariants = cva(
  ...
  {
    variants'border bg-background text-foreground',
...
const Toast = React.forwardRef,
  React.ComponentPropsWithoutRef&
    VariantProps(({ className, variant, ...props }, ref) => {
  return (
...
type ToastProps = React.ComponentPropsWithoutReftype ToastActionElement = React.ReactElementexport {
  type ToastProps,
